...
//    리턴값이 내 예상 id와 일치하는지 확인하면 되겠지
    Assertions.assertThat(savedProId).isEqualTo(16);
...
//    리턴이 프로덕트 타입이니까 검증도 그렇게 해야 하는데. 내용 로그도 좀 찍어보고
    Assertions.assertThat(foundItem.getPname()).isEqualTo("L파일");
...
//    삭제할 대상부터 지정
  ...
  void findAll() {
    ...
    Assertions.assertThat(items.size()).isEqualTo(12);
//    반복문 안 돌려도 다 나오는구나
